...
- Contributing guidelines (version control workflow)  
- Code of Conduct  

### Impact
- Standardized development workflow  
- Improved code quality and reviews  
- Better collaboration across teams  

### Usage
No setup required. Templates and guidelines are automatically applied to all repositories in the organization.
